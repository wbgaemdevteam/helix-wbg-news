export default function decorate(block) {
    ...
    // block.classList.add("FullSize--fullWidth", "FullSize--fullHeight", "Core--pointerEventsNone", "Lazyload", "Lazyload--isLoading");//Lazyload--isLoading should update to Lazyload--isLoaded
    // block.setAttribute('data-lazyload-container', 'true');
    // block.setAttribute('data-lazyload-trigger', 'true');
    // block.offsetParent.classList.add("Layer--two", "FullSize", "FullSize--fixedChild", "FullSize--child", "Theme-BackgroundMedia", "Theme-BackgroundImage");
    // const pictureParent = document.createElement('div');
    // pictureParent.className = "FullSize";
    // pictureParent.setAttribute('data-lazyload-item', 'true');
    // pictureParent.innerHTML = `<picture
    ...
    //         alt="A younger learner in a wheelchair smiles as her wheelchair is pushed by her mother, who in turn smalls down at her young daughter. The mother is wearing a red head covering and a patterned dress with blue, red, and black."
    //         style="object-position:50% 50%">
    // </picture>`;//class HideOffscreen__media--onscreen should be added to img from script
    // block.replaceChildren(pictureParent);
}